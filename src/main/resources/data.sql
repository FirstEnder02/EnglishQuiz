-- Sample seed data for EnglishQuiz
-- Works with MySQL and current entity/table mappings.

-- Clean old sample data safely (child -> parent order)
DELETE FROM answer;
DELETE FROM question;
DELETE FROM quiz_level;
...
-- Levels
INSERT INTO quiz_level (id, category_id, level_name) VALUES
  (101, 1, '1'),
  (102, 1, '2'),
  (201, 2, '1'),
  (202, 2, '2'),
...
INSERT INTO answer (id, question_id, label, text, is_correct) VALUES
  ...
  -- Q3001 (single)
  (5025, 3001, 'A', 'At 5 o''clock', FALSE),
  (5026, 3001, 'B', 'At 6 o''clock', TRUE),
  (5027, 3001, 'C', 'At 7 o''clock', FALSE),
  (5028, 3001, 'D', 'At night', FALSE),

  -- Q3002 (multiple)
  (5029, 3002, 'A', 'Skimming helps find the main idea.', TRUE),
  (5030, 3002, 'B', 'Scanning helps find specific details.', TRUE),
  (5031, 3002, 'C', 'Reading the title is never useful.', FALSE),
  (5032, 3002, 'D', 'Keywords can help comprehension.', TRUE),

  -- Q3003 (single)
  (5033, 3003, 'A', 'Because they were tired', FALSE),
  (5034, 3003, 'B', 'Because it was raining', TRUE),
  (5035, 3003, 'C', 'Because they were hungry', FALSE),
  (5036, 3003, 'D', 'Because they were late', FALSE);
